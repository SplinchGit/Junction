"use strict";
const providers=[
  {id:"local",name:"Local LLM",tag:"This PC",detail:"Runs one selected loopback-only Ollama model. Agent iterations reuse that same model.",models:[{id:"qwen3.5:4b",name:"Qwen3.5 4B",tier:"Recommended"},{id:"qwen3.5:2b",name:"Qwen3.5 2B",tier:"Balanced"},{id:"qwen3:1.7b",name:"Qwen3 1.7B",tier:"Fast"},{id:"lfm2.5:2.6b",name:"LFM2.5 2.6B",tier:"Official GGUF"}]},
