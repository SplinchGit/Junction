package com.splinch.junction.feature.settings.ui
...
fun SettingsScreen(
    ...
    val digestQuietHours by userPrefs.digestQuietHoursFlow.collectAsState(initial = com.splinch.junction.feature.scheduler.DigestQuietHours(false, 22, 7))
    ...
    LazyColumn(
        ...
        item {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Switch(
                    checked = voiceBackend == com.splinch.junction.feature.voice.VoiceBackend.LOCAL,
                    onCheckedChange = { useLocal ->
                        scope.launch {
                            chatManager.setVoiceBackend(
                                if (useLocal) com.splinch.junction.feature.voice.VoiceBackend.LOCAL
                                else com.splinch.junction.feature.voice.VoiceBackend.REALTIME
                            )
                        }
                    }
                )
                    ...
                    scope.launch {
                        withContext(Dispatchers.IO) {
                            keyStorage.setApiKey(
                                com.splinch.junction.feature.voice.local.AzureNeuralVoice.KEY_ID,
        ...
        item {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                com.splinch.junction.feature.scheduler.DigestProfile.entries.forEach { profile ->
